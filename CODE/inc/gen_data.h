...
extern const int g_weapon_base_pool_entries;

extern const int g_weapon_base_pool_count;

extern int g_weapon_base_pool[];

extern ArmorBaseType g_armor_base_ids[];

extern const int g_armor_base_pool_entries;

extern const int g_armor_base_pool_count;
...
extern const int g_item_prefix_pool_entries;

extern const int g_item_prefix_pool_count;
...
namespace ItemConsts {
	...
	enum {
		...
		POT_OF_FULL_HEAL,
		POT_OF_CURE_POISON,
		POT_OF_CURE_PARALYSIS,
		POT_OF_BERSERK_STR,
		POT_OF_SPEED,
		POT_OF_HARDINESS,
		POT_OF_EXTRA_ATTACKS,
		POT_OF_POISON,
		POT_OF_PARALYSIS,
		POT_OF_DEATH
	};
	...
	enum {
		...
		SCROLL_OF_DISCOVERY,
		SCROLL_OF_DECURSE,
		SCROLL_OF_DECURSE_ALL,
		SCROLL_OF_TELEPORT,
		SCROLL_OF_RECALL,
		SCROLL_OF_SUMMON_ITEM,
		SCROLL_OF_DARKNESS,
		SCROLL_OF_FORGET_AREA,
		SCROLL_OF_CURSE
	};
