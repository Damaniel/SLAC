...
ItemPrefixType g_item_prefix_ids[] = {
   ...
   {8, "Unbreakable", 8, 16, 70, 2, {{4, 0, 1.5, 0}, {1, 1, 4, 0}}},
   {9, "Buffed", 9, 128, 25, 1, {{13, 0, 1.2, 0}}},
   {10, "Healthy", 10, 32, 50, 1, {{13, 0, 1.5, 0}}},
   {11, "Immortal", 11, 2, 80, 1, {{13, 0, 2.0, 0}}},
   {12, "Ogre's", 12, 64, 35, 2, {{3, 0, 1.5, 0}, {5, 0, 0.8, 0}}},
   {13, "Flaming", 13, 192, 15, 1, {{3, 2, 0.1, 6}}},
   {14, "Infernous", 14, 96, 50, 1, {{3, 2, 0.5, 6}}},
   {15, "Icy", 15, 192, 15, 1, {{3, 2, 0.1, 7}}},
   {16, "Freezing", 16, 96, 50, 1, {{3, 2, 0.5, 7}}},
   {17, "Sparking", 17, 192, 15, 1, {{3, 2, 0.1, 8}}},
   {18, "Shocking", 18, 96, 50, 1, {{3, 2, 0.5, 8}}},
   {19, "Fire-shrouded", 19, 128, 15, 1, {{14, 0, 0.8, 0}}},
   {20, "Fire-cloaked", 20, 32, 55, 1, {{14, 0, 0.6, 0}}},
   {21, "Ice-shrouded", 21, 128, 15, 1, {{15, 0, 0.8, 0}}},
   {22, "Ice-cloaked", 22, 32, 55, 1, {{15, 0, 0.6, 0}}},
   {23, "Spark-shrouded", 23, 128, 15, 1, {{16, 0, 0.8, 0}}},
   {24, "Spark-cloaked", 24, 32, 55, 1, {{16, 0, 0.6, 0}}},
   {25, "Elemental-shrouded", 25, 64, 15, 3, {{14, 0, 0.9, 0}, {15, 0, 0.9, 0}, {16, 0, 0.9, 0}}},
   {26, "Elemental-cloaked", 26, 8, 55, 3, {{14, 0, 0.8, 0}, {15, 0, 0.8, 0}, {16, 0, 0.8, 0}}},
   {27, "Ignited", 27, 192, 10, 1, {{14, 0, 1.2, 0}}},
   {28, "Engulfed", 28, 96, 40, 1, {{14, 0, 1.4, 0}}},
   {29, "Chilled", 29, 192, 10, 1, {{15, 0, 1.2, 0}}},
   {30, "Chilled", 30, 96, 40, 1, {{15, 0, 1.4, 0}}},
   {31, "Shocked", 31, 192, 10, 1, {{16, 0, 1.2, 0}}},
   {32, "Electrified", 32, 96, 40, 1, {{16, 0, 1.4, 0}}},
   {33, "Element-touched", 33, 32, 20, 3, {{14, 0, 1.1, 0}, {15, 0, 1.1, 0}, {16, 0, 1.1, 0}}},
   {34, "Element-tangled", 34, 8, 50, 3, {{14, 0, 1.2, 0}, {15, 0, 1.2, 0}, {16, 0, 1.2, 0}}},
   {35, "Weak", 35, 160, 10, 1, {{3, 0, 0.9, 0}}},
   {36, "Crippled", 36, 64, 30, 1, {{3, 0, 0.75, 0}}},
   {37, "Slow", 37, 160, 20, 1, {{5, 0, 0.9, 0}}},
   {38, "Halting", 38, 64, 45, 1, {{5, 0, 0.75, 0}}},
   {39, "Frail", 39, 192, 15, 1, {{4, 0, 0.9, 0}}},
   {40, "Defenseless", 40, 96, 35, 1, {{4, 0, 0.75, 0}}},
   {41, "Infirm", 41, 128, 25, 1, {{13, 0, 0.9, 0}}},
   {42, "Sickly", 42, 32, 50, 1, {{13, 0, 0.75, 0}}}
};
