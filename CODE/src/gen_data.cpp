...
PotionType g_potion_ids[] = {
   ...
   {3, "Potion of Cure Poison", "Removes poison", 133, 0, 3, 200, 2, 20, false, false, false, true, false, true, true},
...
ItemPrefixType g_item_prefix_ids[] = {
   ...
   {3, "Quick", "+3% SPD", 3, 240, 5, 1, {{5, 0, 1.03, 0}}},
   {4, "Speedy", "+7% SPD, +1 DEX", 4, 128, 20, 2, {{5, 0, 1.07, 0}, {2, 1, 1, 0}}},
   {5, "Supersonic", "+12% SPD, +4 DEX", 5, 16, 70, 2, {{5, 0, 1.12, 0}, {2, 1, 4, 0}}},
   {6, "Stout", "+5% DEF", 6, 240, 5, 1, {{4, 0, 1.05, 0}}},
   {7, "Hardy", "+10% DEF, +1 CON", 7, 128, 20, 2, {{4, 0, 1.1, 0}, {1, 1, 1, 0}}},
   {8, "Unbreakable", "+20% DEF, +4 CON", 8, 16, 70, 2, {{4, 0, 1.2, 0}, {1, 1, 4, 0}}},
   {9, "Buffed", "+10% HP", 9, 128, 25, 1, {{13, 0, 1.1, 0}}},
   {10, "Healthy", "+20% HP", 10, 32, 50, 1, {{13, 0, 1.2, 0}}},
   {11, "Immortal", "+40% HP", 11, 2, 80, 1, {{13, 0, 1.4, 0}}},
   {12, "Ogre's", "+50% ATK, -20% SPD", 12, 64, 35, 2, {{3, 0, 1.5, 0}, {5, 0, 0.8, 0}}},
   {13, "Flaming", "+10% of damage as fire", 13, 192, 15, 1, {{3, 2, 0.1, 6}}},
   {14, "Infernous", "+25% of damage as fire", 14, 96, 50, 1, {{3, 2, 0.25, 6}}},
   {15, "Icy", "+10% of damage as ice", 15, 192, 15, 1, {{3, 2, 0.1, 7}}},
   {16, "Freezing", "+25% of damage as ice", 16, 96, 50, 1, {{3, 2, 0.25, 7}}},
   {17, "Sparking", "+10% of damage as lightning", 17, 192, 15, 1, {{3, 2, 0.1, 8}}},
   {18, "Shocking", "+25% of damage as lightning", 18, 96, 50, 1, {{3, 2, 0.25, 8}}},
...
EnemyType g_enemy_ids[] = {
   ...
   {9, "brown worm", 1, 9, 22, 15, 75, 15, 17, 1, 0, 0, 0, 0, 0, 0, 17, 5, 5, 255, 1},
   {10, "slug", 1, 10, 24, 15, 80, 15, 18, 1, 0, 0, 0, 0, 0, 0, 20, 6, 6, 255, 1},
   {11, "black worm", 0, 11, 25, 14, 80, 15, 18, 1, 0, 0, 0, 0, 0, 0, 22, 6, 6, 255, 1},
   {12, "putrid pup", 1, 12, 35, 18, 80, 19, 20, 1, 0, 0, 0, 0, 0, 0, 28, 7, 7, 255, 2},
   ...
   {17, "sprite", 10, 17, 60, 19, 80, 15, 18, 1, 0, 0, 2, 10, 10, 10, 42, 9, 9, 255, 1},
   ...
   {20, "small gray bat", 10, 20, 75, 22, 80, 23, 25, 1, 0, 0, 0, 0, 0, 0, 60, 11, 11, 255, 1},
   {21, "small blue bat", 10, 21, 77, 15, 50, 13, 20, 1, 0, 4, 0, 5, 5, 5, 62, 11, 11, 255, 1},
   ...
   {30, "antman", 0, 30, 95, 31, 70, 31, 35, 1, 0, 0, 0, 0, 0, 0, 105, 16, 16, 255, 1},
   ...
   {33, "flipper", 11, 33, 90, 40, 50, 40, 36, 1, 0, 0, 0, 0, 0, 0, 120, 17, 17, 255, 2},
   {34, "snail", 0, 34, 90, 40, 80, 38, 40, 1, 0, 0, 0, 0, 0, 0, 126, 18, 18, 255, 1},
   {35, "blue jelly", 10, 35, 90, 40, 80, 20, 36, 1, 0, 3, 0, 0, 50, 0, 131, 18, 18, 255, 2},
   {36, "crab", 0, 36, 100, 44, 80, 40, 40, 1, 0, 0, 0, 0, 0, 0, 137, 19, 19, 255, 1},
   {37, "blue fungus", 2, 37, 70, 25, 50, 28, 44, 1, 0, 3, 0, 0, 50, 0, 143, 19, 19, 255, 1},
   {38, "brown fungus", 1, 38, 110, 37, 50, 52, 42, 1, 0, 0, 0, 0, 0, 0, 149, 20, 20, 255, 1},
   {39, "spirit", 12, 39, 110, 37, 80, 48, 40, 1, 0, 0, 0, 30, 30, 30, 156, 20, 20, 255, 1},
   ...
   {44, "feline thief", 12, 44, 130, 42, 90, 44, 55, 1, 0, 0, 0, 0, 0, 0, 184, 23, 23, 255, 3},
   {45, "zombie", 1, 45, 130, 42, 50, 50, 55, 1, 0, 0, 0, 0, 0, 0, 189, 23, 23, 255, 2},
   ...
   {48, "bleached skeleton", 1, 48, 130, 50, 70, 50, 50, 1, 2, 0, 0, 0, 0, 0, 202, 25, 25, 255, 2},
   ...
   {52, "tick", 5, 52, 100, 55, 120, 55, 65, 1, 0, 0, 0, 0, 0, 0, 228, 27, 27, 255, 1},
   ...
   {58, "mudman", 13, 58, 200, 67, 80, 67, 75, 1, 0, 0, 0, 0, 0, 0, 266, 30, 30, 255, 3},
   ...
   {61, "snake", 5, 61, 230, 75, 75, 75, 70, 1, 0, 0, 0, 10, 10, 10, 286, 31, 31, 255, 1},
   {62, "black_snake", 2, 62, 240, 80, 80, 75, 70, 1, 0, 0, 0, 10, 10, 10, 293, 32, 32, 255, 1},
   {63, "green snake", 2, 63, 220, 80, 100, 75, 60, 1, 0, 0, 0, 0, 0, 0, 300, 32, 32, 255, 1},
   ...
   {67, "flying snake", 12, 67, 250, 90, 50, 90, 80, 1, 0, 0, 0, 15, 15, 15, 325, 34, 34, 255, 1},
   ...
   {71, "gorgon", 13, 71, 250, 40, 80, 75, 70, 1, 3, 3, 3, 0, 0, 0, 351, 36, 36, 255, 2},
   {72, "shambling dead", 2, 72, 210, 90, 80, 102, 85, 1, 0, 0, 0, 25, 25, 25, 358, 37, 37, 255, 3},
   ...
   {81, "large flea", 5, 81, 250, 100, 90, 108, 60, 3, 0, 0, 0, 0, 0, 0, 424, 41, 41, 255, 1},
   {82, "gila monster", 0, 82, 400, 100, 70, 100, 85, 1, 8, 0, 0, 0, 0, 0, 432, 42, 42, 255, 2},
   {83, "flapper", 14, 83, 350, 95, 80, 100, 90, 1, 0, 0, 0, 90, 90, 90, 439, 42, 42, 255, 1},
   {84, "eel", 0, 84, 350, 115, 70, 115, 100, 1, 0, 0, 0, 0, 0, 0, 447, 43, 43, 255, 1},
   {85, "yellow fungus", 4, 85, 400, 120, 30, 125, 50, 1, 0, 0, 4, 0, 0, 0, 455, 43, 43, 255, 1},
   {86, "hound", 0, 86, 350, 125, 70, 115, 90, 1, 2, 0, 0, 20, 0, 0, 462, 44, 44, 255, 2},
   {87, "brown spider", 3, 87, 350, 125, 70, 118, 93, 1, 0, 0, 0, 0, 0, 0, 469, 44, 44, 255, 1},
   ...
   {95, "moss man", 4, 95, 420, 140, 60, 140, 120, 1, 0, 0, 0, 0, 20, 0, 530, 48, 48, 255, 2},
   ...
   {104, "rabid squirrel", 3, 104, 500, 141, 90, 142, 130, 1, 0, 0, 0, 0, 0, 0, 592, 53, 53, 255, 1},
   {105, "fairy", 13, 105, 340, 30, 80, 120, 120, 2, 3, 3, 3, 60, 60, 60, 599, 53, 53, 255, 2},
   {106, "gray bat", 13, 106, 540, 120, 80, 145, 130, 1, 0, 0, 0, 0, 0, 0, 607, 54, 54, 255, 1},
   ...
   {110, "toxic rat", 3, 110, 520, 120, 70, 145, 130, 2, 0, 0, 0, 30, 30, 30, 637, 56, 56, 255, 2},
   ...
   {115, "rotten dog", 5, 115, 550, 155, 80, 155, 145, 1, 0, 0, 0, 25, 25, 25, 674, 58, 58, 255, 2},
   {116, "toxic skeleton", 6, 116, 560, 160, 40, 187, 155, 1, 0, 0, 0, 0, 0, 0, 681, 59, 59, 255, 3},
   ...
   {122, "giant toad", 5, 122, 610, 180, 80, 175, 170, 1, 0, 0, 0, 0, 0, 0, 726, 62, 62, 255, 1},
   ...
   {126, "basilisk", 7, 126, 680, 180, 90, 180, 160, 1, 0, 0, 0, 0, 0, 0, 757, 64, 64, 255, 2},
   {127, "red basilisk", 8, 127, 680, 100, 90, 180, 150, 1, 5, 0, 0, 90, 0, 0, 764, 64, 64, 255, 2},
   {128, "rabid gray squirrel", 7, 128, 690, 180, 90, 170, 170, 2, 0, 0, 0, 0, 0, 0, 771, 65, 65, 255, 1},
   ...
   {135, "turtle", 13, 135, 550, 200, 40, 205, 190, 1, 0, 0, 0, 0, 0, 0, 821, 68, 68, 255, 1},
   ...
   {139, "giant snail", 7, 139, 720, 210, 80, 210, 180, 1, 0, 0, 0, 0, 0, 0, 850, 70, 70, 255, 1},
   {140, "giant fly", 13, 140, 650, 190, 110, 190, 160, 2, 0, 0, 0, 0, 0, 0, 857, 71, 71, 255, 1},
   {141, "giant sandworm", 0, 141, 720, 200, 70, 210, 180, 1, 0, 0, 0, 0, 0, 0, 864, 71, 71, 255, 2},
   {142, "scorpion", 6, 142, 750, 125, 80, 200, 175, 1, 1, 1, 1, 0, 0, 0, 871, 72, 72, 255, 1},
   ...
   {153, "stone scorpion", 8, 153, 750, 200, 50, 235, 220, 1, 0, 0, 0, 70, 70, 70, 941, 77, 77, 255, 2},
   ...
   {163, "mossy crab", 0, 162, 900, 240, 80, 245, 220, 1, 0, 0, 0, 0, 0, 0, 1013, 82, 82, 255, 1},
   {164, "orange fungus", 8, 164, 850, 160, 50, 245, 220, 2, 0, 1, 1, 75, 75, 75, 1020, 83, 83, 255, 1},
   ...
   {177, "gelatinous cube", 0, 177, 1100, 250, 70, 250, 220, 1, 0, 0, 0, 0, 0, 0, 1110, 89, 89, 255, 1},
   ...
   {188, "faded fungus", 15, 188, 1050, 260, 40, 280, 200, 2, 3, 3, 3, 0, 0, 0, 1184, 95, 95, 255, 2},
   {189, "hooded one", 0, 189, 1050, 255, 70, 270, 215, 3, 0, 0, 0, 0, 0, 0, 1191, 95, 95, 255, 2},
   {190, "shade", 9, 190, 800, 255, 110, 235, 220, 3, 0, 0, 0, 0, 0, 0, 1199, 96, 96, 255, 2},
   {191, "shrouded one", 14, 191, 1100, 140, 70, 240, 220, 2, 5, 5, 5, 0, 0, 0, 1206, 96, 96, 255, 2},
   {192, "zealot", 14, 192, 1100, 200, 70, 220, 230, 2, 0, 0, 10, 0, 0, 0, 1213, 97, 97, 255, 2},
   ...
   {196, "elder dragon", 15, 196, 1250, 260, 80, 290, 230, 2, 0, 0, 0, 0, 0, 0, 1242, 99, 99, 255, 4},
   {197, "vampire", 9, 197, 1200, 100, 80, 225, 190, 3, 4, 4, 4, 0, 0, 0, 1249, 99, 99, 255, 2},
   ...
   {200, "Prang, war elephant", 11, 200, 200, 35, 70, 32, 20, 2, 0, 0, 0, 0, 0, 0, 400, 12, 12, 255, 3},
   {201, "Steenkey, elder naga", 4, 201, 350, 40, 70, 50, 50, 2, 1, 1, 1, 0, 0, 0, 750, 25, 25, 255, 3},
   {202, "Nameless, black orc", 13, 202, 530, 100, 90, 155, 120, 1, 1, 1, 1, 50, 50, 50, 2500, 50, 50, 255, 4},
   {203, "Groz, goblin king", 6, 203, 1000, 190, 75, 225, 205, 2, 0, 0, 0, 0, 0, 0, 5000, 70, 70, 255, 5},
   {204, "Lortrox, dragon knight", 14, 204, 800, 160, 70, 160, 150, 3, 0, 0, 0, 0, 0, 0, 10, 55, 55, 255, 4},
   {205, "Silant, ice giant", 15, 205, 1400, 160, 75, 255, 200, 2, 0, 10, 0, 80, 90, 80, 7500, 80, 80, 255, 5},
   {206, "Megalith, armored beast", 9, 206, 3500, 255, 120, 280, 280, 3, 15, 15, 15, 85, 85, 85, 10000, 100, 100, 255, 6}
};
