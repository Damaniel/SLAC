...
//
EnemyType g_enemy_ids[] = {
   {0, "slime", 0, 0, 3, 3, 3, 3, 100, 1, 0, 0, 0, 0, 0, 0, 2, 1, 255, 1, 1},
   {1, "brown rat", 1, 0, 3, 3, 3, 3, 110, 1, 0, 0, 0, 0, 0, 0, 2, 1, 255, 1, 1},
   {2, "skeleton", 2, 0, 3, 3, 3, 3, 120, 1, 0, 0, 0, 0, 0, 0, 2, 1, 255, 1, 1},
   {3, "zombie", 3, 0, 3, 3, 3, 3, 130, 1, 0, 0, 0, 0, 0, 0, 2, 1, 255, 1, 1},
   {4, "ant", 4, 0, 3, 3, 3, 3, 100, 1, 0, 0, 0, 0, 0, 0, 2, 1, 255, 1, 1},
   {5, "spider", 5, 0, 3, 3, 3, 3, 110, 1, 0, 0, 0, 0, 0, 0, 2, 1, 255, 1, 1},
   {6, "brown bat", 6, 0, 3, 3, 3, 3, 120, 1, 0, 0, 0, 0, 0, 0, 2, 1, 255, 1, 1},
   {7, "kobold", 7, 0, 3, 3, 3, 3, 130, 1, 0, 0, 0, 0, 0, 0, 2, 1, 255, 1, 1},
   {8, "archdemon", 8, 0, 3, 3, 3, 3, 100, 1, 0, 0, 0, 0, 0, 0, 2, 1, 255, 1, 1},
   {9, "wolf", 9, 0, 3, 3, 3, 3, 110, 1, 0, 0, 0, 0, 0, 0, 2, 1, 255, 1, 1}
};
